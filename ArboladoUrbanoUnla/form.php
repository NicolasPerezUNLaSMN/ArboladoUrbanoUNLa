  ...
  <body>
    ...
    <div class="container">
      <form class="needs-validation" novalidate action="/actionWebForm.php" method="post" enctype="multipart/form-data">
        ...
        <div class="form-group">
          <label for="numeroFrente">numero de frente</label>
          <input
            name="numeroFrente"
             type="number" step="any"
            class="form-control"
        ...
        <div class="form-group">
          ...
          <input
            ...
            id="anchoVereda"
            name="anchoVereda"
            placeholder="Ingrese el ancho de la vereda (mt)"
          />
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
          ...
          <select class="custom-select" id="especie" name="especie" required>
        ...
        <div class="form-group">
          ...
          <input
            ...
            placeholder="Ingrese distancia (mt)"
          />
        </div>
        <div class="form-group">
          ...
          <input
            ...
            class="form-control"
            id="distanciaAlMuro"
            placeholder="Ingrese distancia al muro (mt)"
          />
        </div>
        <div class="form-group">
          ...
          <input
            ...
            class="form-control"
            id="diametro"
            placeholder="Ingrese el diamtro (mt)"
          />
        </div>
        <div class="form-group">
          ...
          <input
            ...
            class="form-control"
            id="altura"
            placeholder="Ingrese la altura (mt)"
            required
          />
          <div class="invalid-feedback">
            Por favor ingrese la altura del árbol
          </div>
        </div>
        <div class="form-group">
          ...
          <input
            ...
            class="form-control"
            id="cordon"
            placeholder="Cordon (mt)"
            required
          />
          <div class="invalid-feedback">
            Por favor ingrese el cordon
          </div>
        </div>
        <div class="form-group">
          ...
          <input
            ...
            placeholder="Ingrese la circunferencia del arbol (mt)"
          />
        </div> 
        <div class="form-group">
        ...
        <div class="form-group">
          ...
          <select class="custom-select" id="raices" name="raices" required>
            <option selected disabled value="">Raices</option>
            <option>20%</option>
            <option>40%</option>
            <option>60%</option>
            <option>80%</option>
        ...
        <div class="form-group">
          ...
          <input
            ...
            class="form-control"
            id="superficie"
            placeholder="Ingrese la superficie afectada (mt)"
            required
          />
          <div class="invalid-feedback">
        ...
        <div class="form-group">
          ...
          <select class="custom-select" id="raices" name="afecto" required>
        ...
        <div class="form-group">
          ...
          <select class="custom-select" id="danios" name="danios" required>
        ...
        <div class="form-group">
          ...
          <select class="custom-select" id="veredas" name="veredas" required>
        ...
        <div class="form-group">
          ...
          <select class="custom-select" id="podas" name="podas" required>
